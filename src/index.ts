...
// Patterns for refactoring Analyzer class parts to be more composable.
...
// abstract class AbstractUpdateCore<R, T extends CoreType> extends HasPropCore<T> {
//     abstract update(coreMutable: CoreUpdateProps<T>): R
// }

// class Updater<T extends CoreType> extends AbstractUpdateCore<Updater<T>, T> {
//   constructor(readonly core: Core<T>) { super(core) }
//   update(coreMutable: CoreUpdateProps<T>) {
//       return new Updater({ ...this.core, mutable: {
//           ...this.core.mutable,
//           ...coreMutable
//       }})
//   }
...
// class MakePropFoo<A extends AbstractUpdateCore<any, any>> {
...
//     }
//     update(coreMutable: CoreUpdateProps<T>) {
//         return new BigClass({ ...this.core, mutable: {
//             ...this.core.mutable,
//             ...coreMutable
//         } });
//   }
...
// Alright, so I want to get access to the last version of this that had
// the old addSecitons
// I want to reimplement that.

// But I want to keep the new functions and State stuff.

// The best way forward is to get the old addSection
// to work with the new StateSection
