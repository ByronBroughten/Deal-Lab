  ...
  return checkTypeUniformityVarbs(
    checkAllBaseSectionVarbs({
      ...
      deal: varbs({
        ...
        ...bvsS.monthsYears("timeTillValueAddProfit"),
        ...bvsS.periodicDollars("ongoingPiti"),
        ...bvsS.periodicDollars("ongoingLoanPayment"),
        ...bvsS.periodicDollars("expensesOngoing"),
        ...bvsS.periodicDollars("averageNonPrincipalOngoing"),
        ...bvsS.periodicDollars("cashFlow"),
        ...bvsS.periodicDollars("netNonPrincipalOngoing"),
        ...bvsS.periodicDollars2("netExpensesOngoing"),
        ...bvsS.periodicDecimal("cocRoiDecimal"),
        ...bvsS.periodicPercent("cocRoi"),

        ...bvsS.monthsYears("refiLoanHolding"),
        ...bvsS.monthsYears("purchaseLoanHolding"),
      ...
      financing: varbs({
        ...
        financingMode: bv("financingMode"),
        ...bvsS.periodicDollars("mortgageIns"),
        ...bvsS.periodicDollars("loanExpenses"),
        ...bvsS.periodicDollars("loanPayment"),
        ...bvsS.monthsYearsInput("timeTillRefinance"),
        ...bvsS.periodicDollars("averagePrincipal"),
        ...bvsS.periodicDollars("averageInterest"),
        ...baseVarbs(
          "numObj",
          [
            "loanBaseDollars",
