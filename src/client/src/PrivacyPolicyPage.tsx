...
export function PrivacyPolicyPage() {
  return (
    <PageMain style={{ padding: "20px" }}>
      ...
      <p>
        At Ultimate Property Analyzer, accessible from
        https://www.ultimatepropertyanalyzer.com, one of our main priorities is
        the privacy of our visitors. This Privacy Policy document contains types
        of information that is collected and recorded by Ultimate Property
        Analyzer and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Ultimate Property Analyzer. This policy is not
      ...
      <p>
        Ultimate Property Analyzer follows a standard procedure of using log
      ...
      <p>
        Like any other website, Ultimate Property Analyzer uses 'cookies'. These
      ...
      <p>
        ...
        advertising partners of Ultimate Property Analyzer.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Ultimate Property Analyzer,
      ...
      <p>
        Note that Ultimate Property Analyzer has no access to or control over
      ...
      <p>
        Ultimate Property Analyzer's Privacy Policy does not apply to other
      ...
      <p>
        Ultimate Property Analyzer does not knowingly collect any Personal
