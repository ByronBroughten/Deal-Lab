...
} from "./schema3SectionStructures/baseSectionVarbs";
import { baseOptions } from "./schema3SectionStructures/baseUnits";
import { baseVarbs, bv, bvsS } from "./schema3SectionStructures/baseVarbs";
...
export type Schema2SectionStructures = typeof schema2SectionStructures;
export const schema2SectionStructures = makeSectionStructures();

export function makeSectionStructures() {
