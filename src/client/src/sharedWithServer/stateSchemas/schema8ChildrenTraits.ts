...
function checkSchema6ChildrenTraits<RCS extends GenericAllChildrenTraits>(
  rcs: RCS
): RCS {
  return rcs;
}
...
export const schema6ChildrenTraits = checkSchema6ChildrenTraits({
...
type AllChildrenTraits = typeof schema6ChildrenTraits;
