...
import { GeneralChildrenSections } from "../schema6SectionChildren/sectionChildren";
...
>(_sn: SN, _csn: CSN) {
  const _test1: ChildSectionNameName<"property", "miscPeriodicValue"> =
    "miscOngoingCost";
  //@ts-expect-error
...
_testChildSectionNameName("property", "miscOnetimeValue");
