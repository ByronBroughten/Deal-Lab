...
import ErrorMessage from "../../App/components/appWide/ErrorMessage";
import ItemOrCommaSpan, {
  CommaSpan,
  ItemSpan,
} from "../../App/components/inputs/ListEditor/ItemOrCommaSpan";
...
import { insertEntity } from "../../App/modules/draftjs/insert";
...
export default function ListEditor({
  ...
  // this will eventually come from varb
  const error = false;
