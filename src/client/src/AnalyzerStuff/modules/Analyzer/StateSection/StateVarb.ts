...
import { valueMeta } from "../../../../App/sharedWithServer/SectionsMeta/baseSections/baseValues";
import {
  InEntities,
  InEntity,
...
import { DisplayName } from "../../../../App/sharedWithServer/SectionsMeta/relSections/rel/relVarbTypes";
import {
  DbValue,
  UpdateFnName,
  ValueTypes,
...
import { cloneValue } from "../../../../App/sharedWithServer/SectionsMeta/VarbMeta";
...
export default class StateVarb {
  ...
  get fullName(): string {
    return StateVarb.feVarbInfoToVarbId(this.feVarbInfo);
  }
  get varbName() {
  ...
  static varbIdToFeVarbInfo(fullName: string): FeVarbInfo {
